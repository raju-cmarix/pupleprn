...
export default function MalPracticeLicenseExpiryPopup({ modal, toggle, clinicianId }) {
  ...
  const updateNotificationSetting = (shouldNavigate) => {
    api(CLINICIAN_NOTIFICATION_SETTING_UPDATE, {
      ...
      isShowMalPracticeLicensePopup: false,
    })
      .then((res) => {
  ...
  return (
    ...
    >
      ...
      <ModalBody>
        ...
        Your malpractice insurance is about to expire, please go to account settings and update your expiration date.
        </p>
